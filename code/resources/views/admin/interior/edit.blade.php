...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.interior.update') }}" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
         ...
         <div class="mb-3">
                ...
                <input type="text" class="form-control" name="image_url_old" value="{{$interior->image_url}}" hidden>
            </div>  

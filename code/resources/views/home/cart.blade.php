                            ...
                            @forelse (session('cart',[]) as $item)
                                ...
                                <th scope="row">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ $item['image'] ? asset('storage/' . $item['image']) : asset('images/no-image.png') }}" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px;" alt="">
                                    </div>
                                </th>
                                <td>
                                ...
                                <td>
                                    <p class="mb-0 mt-4">{{ number_format($item['price'],0) }}</p>
                                </td>
                                <td>
                    ...
                    <div class="col-sm-8 col-md-7 col-lg-6 col-xl-4">
                        <div class="bg-light rounded">
                            ...
                            <div class="py-4 mb-4 border-top border-bottom d-flex justify-content-between">
                                ...
                                <p class="mb-0 pe-4 cart-total">{{ number_format($cartTotal) }}đ</p>
                            </div>

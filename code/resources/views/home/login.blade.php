...
<head>
    ...
    <style>
        ...
        .card-login{ width:380px; border-radius:8px; }
        .header{ background:#fff; box-shadow:0 2px 6px rgba(0,0,0,0.06); }
...
<!-- MAIN -->
<div class="container-fluid bg-main d-flex align-items-center justify-content-center" style="min-height:60vh; animation:fadeIn 0.8s;">
    <div class="row justify-content-center align-items-center w-100">
        ...
        <div class="col-lg-6 text-center text-white d-none d-lg-flex flex-column align-items-center justify-content-center">
            <img src="https://upload.wikimedia.org/wikipedia/commons/1/1f/Shopee_logo.svg" height="180" class="mb-4" alt="logo"/>
            ...
            <div class="card card-login p-4 shadow-sm" style="animation:slideDown 0.7s;">
                ...
                <form action="#" method="post">
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="identifier" placeholder="Email / Số điện thoại" />
                    </div>
                    <div class="mb-3">
                ...
                <div class="text-center mt-3">
                    Bạn mới tham gia? <a href="register.html">Đăng ký</a>
                </div>
            </div>
        </div>
...
<div class="container py-5">
    <div class="row text-muted">
        ...
        <div class="col-md-3">
            ...
            <img src="https://upload.wikimedia.org/wikipedia/commons/5/5f/QR_code_example.svg" height="100" alt="qr"/>
        </div>
    </div>
</div>

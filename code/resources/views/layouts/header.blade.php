        ...
        <div class="container-fluid fixed-top">
            ...
            <div class="container px-0">
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    <a href="{{route('home.index',[],false)}}" class="navbar-brand"><h1 class="text-primary display-6">TRUNG KIÊN</h1></a>
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Nội thất</a>
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    <a href="cart.html" class="dropdown-item">Cart</a>
                                    <a href="{{route('home.checkout',[],false)}}" class="dropdown-item">Checkout</a>
                        ...
                        <div class="d-flex m-3 me-0">
                            ...
                            <a href="{{route('home.cart',[],false)}}" class="position-relative me-4 my-auto">
